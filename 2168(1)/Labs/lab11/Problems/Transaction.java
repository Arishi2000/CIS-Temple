...
// ascending order of account number
   ...
   public static void main(String[] args) {
      final int numOLines = 4;  // number of lines n the input file (either 10, 100, or 100000)
      In n = new In("4records.txt");  // input files: 10records.txt, 100records.txt, or 1000000records.txt
      Transaction[] a = new Transaction[numOLines];  // allocate an array of Transaction objects

      // populate the array of transaction objects
      for (int line = 0; line < numOLines; line++) {
         a[line] = new Transaction(n.readLine());
      }
     ...
     // YOUR CODE HERE
      ...
      In in = new In("1000000records.txt");
      final int numOfLines = 1000000;
